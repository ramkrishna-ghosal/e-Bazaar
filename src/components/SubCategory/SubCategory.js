...
class SubCategory extends Component {
            ...
            empdata = this.state.filteredData.map((data, index) => {
                return (
                    <tr key={data.id}>
                        ...
                        <td>
                            <Link to={"/product/" + data.subCategoryId}>{data.subCategoryId}</Link>
                        </td>
                        <td>
                            {data.name}
                        </td>
    ...
    componentDidMount() {
        ...
        axios.get('admin/subcategories/cat/' + categoryId).then(res => {
    ...
    toggleActive(data, index) {
        ...
        axios.delete(config.baseURL + 'admin/subcategories/' + data[index].id, payload).then(res => {
            this.setState({ fetchedData: data });
        })
    }
